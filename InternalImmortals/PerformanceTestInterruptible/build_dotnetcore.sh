...
echo "&&&&&&&&&&&&&&&&&&  Build_dotnetcore.sh &&&&"
../../bin/AmbrosiaCS CodeGen -a "publish/ServerAPI.dll" -a "publish/IJob.dll" -p "API/ServerAPI.csproj" -p "IJob/IJob.csproj" -o $GENDEST -f "net46" -f "netcoreapp3.1" 
set +x
